...
| 指標 | 件数 |
|---|---|
| PDFの自動発見に成功 | 222/254 (87%) |
| 収益構造・業種別貸出金・有価証券ポートフォリオの3項目すべて取得 | 85/254 (33%) |
| 3項目のうち1つ以上取得 | 179/254 (70%) |
| 収益構造(損益の状況)を取得 | 166/222 |
| 業種別貸出金を取得 | 140/222 |
| 有価証券ポートフォリオを取得 | 110/222 |
| PDFが発見できなかった | 20/254 |
| ダウンロード・解析エラー | 12/254 |
| PDFは発見・処理できたが3項目とも抽出できなかった | 43/254 |

47金庫サンプルとほぼ同じ歩留まりが254金庫全体でも再現された。
